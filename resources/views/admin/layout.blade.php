    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto align-items-center">
            ...
            <li class="nav-item dropdown">
                <ul>
                    @auth
                        <li class="btn btn-lg btn-primary"><button href="#" class="btn">{{ auth()->user()->name }}</button></li>
                        <li class="btn btn-lg btn-outline-warning"><a href="{{ route('logout') }}" class="btn" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Đăng xuất</a></li>
